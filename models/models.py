...
#     _name='loaidiem'
#     name = fields.Char(compute='name_',store=True)
#     cham_diem = fields.Boolean(default=True,string=u'Có chấm điểm hay không?',compute='cham_diem_')
#     parent_require = fields.Boolean(string=u'Cần có field parent_id')
#     lay_thong_tin_cua_cvi_parent_id = fields.Boolean(string=u'Lấy thông tin của công việc cha?')
#     cong_viec_cha_hay_con_hay_don = fields.Selection([(u'Công Việc Cha',u'Công Việc Cha'),(u'Công Việc Con',u'Công Việc Con'),(u'Công Việc Đơn',u'Công Việc Đơn')],string=u'Công việc cha hay con hay công việc đơn')
#     dac_diem = fields.Selection([(u'Nhiều Người Làm Cùng 1 Lúc',u'Nhiều Người Làm Cùng 1 Lúc'),(u'Làm Theo Giai Đoạn',u'Làm Theo Giai Đoạn')],string=u'Đặc Điểm')
#     @api.depends('cong_viec_cha_hay_con_hay_don')
#     def cham_diem_(self):
#         for r in self:
#             if r.cong_viec_cha_hay_con_hay_don ==u'Công Việc Cha':
#                 r.cham_diem =False
#             else:
#                 r.cham_diem = True
#     
#     @api.depends('cong_viec_cha_hay_con_hay_don','dac_diem','cham_diem')
#     def name_(self):
#         for r in self:
#             name  = name_compute(r,adict=[('cong_viec_cha_hay_con_hay_don',{}),
#                                           ('dac_diem',{'pr':u'Đặc Điểm','skip_if_False':True},),
#                                           ('cham_diem',{'pr':u'Chấm Điểm','fnc':lambda v: u'Có' if v else u'Không'},),
#                                           ]
#                                  )
#             r.name = name
#             
